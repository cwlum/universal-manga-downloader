...
2. Paste the raw URL: `https://raw.githubusercontent.com/0xH4KU/universal-manga-downloader/main/community-plugins/parsers/your_plugin.py`
3. Click Install

## Available Plugins

See the [Plugin Wiki](https://github.com/0xH4KU/universal-manga-downloader/wiki) for a complete list of available plugins.

## Contributing

See [Plugin Submission Guide](https://github.com/0xH4KU/universal-manga-downloader/wiki/Plugin-Submission-Guide) in our wiki.
